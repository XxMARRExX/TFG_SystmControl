...
%% Cargar la imagen
nombreImagen = "Imagen8_25062025_v2";
disp("1 -- Paso de la imagen a gris --")
image = imread("pictures/Imagen4.png");
rescaledImage = imresize(image, 0.3);
...
title('Imagen reescalada (30%)');

fprintf("Tamaño de las imágenes:");
disp(size(image));
disp(size(rescaledImage));
...
newEdges_2 = filterByHorizontalDensity(newEdges, ...
...
edgesPiece = generateVerticalRegionFromEdges(edges, newEdges_2, ...
